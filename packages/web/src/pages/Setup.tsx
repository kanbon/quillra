      ...
      <main className="mx-auto w-full max-w-xl flex-1 px-6 py-14">
        ...
        <div className="overflow-hidden rounded-3xl border border-neutral-200/80 bg-white shadow-sm">
          ...
          {step === "githubApp" && (() => {
            ...
            const installUrlFromCallback = searchParams.get("installUrl") ?? "";
            // If the user bounced back from github.com/installations/new we
            // also get installation_id in the query — no server write needed,
            // the token mint path picks it up automatically on first push.
              ...
              <div className="p-8">
                  ...
                  <>
                    <div className="mt-6 rounded-xl border border-neutral-200 bg-neutral-50 p-4 text-[13px] leading-relaxed text-neutral-600">
                      ...
                      <ol className="mt-2 list-decimal space-y-1 pl-5">
                        ...
                        <li>GitHub shows a one-screen preview and you approve</li>
                        <li>You come back here and pick which repos the App can touch</li>
                      </ol>
                    </div>
                    <a
                ...
                {(appConfigured || justCreated) && (
                  <>
                      ...
                      <div className="flex items-start gap-2.5">
                        ...
                        <div>
                          <p className="text-sm font-semibold text-green-900">
                            {justInstalled ? "App installed." : justCreated ? "App created." : "App configured."}
                          </p>
                          <p className="mt-0.5 text-[12px] leading-snug text-green-800">
                            ...
                            {installationId ? (
                              ...
                              "Now install it on the repos you want Quillra to edit."
                            )}
                          </p>
                        </div>
                      </div>
                    ...
                    {installUrlFromCallback && !justInstalled && (
                      <a
                        href={installUrlFromCallback}
                        className="mt-5 flex h-11 w-full items-center justify-center gap-2 rounded-md bg-brand px-4 text-[14px] font-semibold text-white shadow-sm transition-colors hover:bg-brand/90"
                      >
